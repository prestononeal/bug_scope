...
// Based on Coursera's Rails capstone demo app
// https://github.com/jhu-ep-coursera/capstone_demoapp/blob/external-rails/gulpfile.js
...
var cfg={
  ...
  apiUrl: { dev: "http://localhost:3000",
            prd: "https://myurl.herokuapp.com"}  // TODO: CHANGE THIS
};
...
// prepare the development area - run the clean:build task serially (via sync), instead of in parallel
